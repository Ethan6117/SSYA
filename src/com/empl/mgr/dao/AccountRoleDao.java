...
public class AccountRoleDao extends AbstractDao<TeAccountRole> {
	...
	@SuppressWarnings("unchecked")
	public List<String> findAcctNameByRoleId(long roleId) {
		// TODO Auto-generated method stub
		StringBuffer query = new StringBuffer();
		query.append("select acctNickname from te_account a JOIN te_account_role ar ON a.acctName = ar.acctName where ar.roleLabel=(select r.roleLabel from te_role r where r.roleId="+roleId+")");
		return findSession().createSQLQuery((query.toString())).list();
	}
