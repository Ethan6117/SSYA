...
public class EmployeesInfoDto implements Serializable {
	...
	private boolean paySocialSecurity; // 是否缴纳社保
	private String note; // 备注
	private String notetype; // 户口类型
	...
	private EmployeesEduDto[] edu ; // 教育经历
	...
	public EmployeesInfoDto(long emplId, String fullName, String photo, boolean sex, String identity, String birthday,
			...
			boolean paySocialSecurity, String note, EmployeesAddressDto register, EmployeesAddressDto current,
			EmployeesCompnayDto[] company,EmployeesEduDto[] edu) {
		super();
		this.emplId = emplId;
	...
	public EmployeesEduDto[] getEdu() {
		return edu;
	}

	public void setEdu(EmployeesEduDto[] edu) {
		this.edu = edu;
	}
