...
public class AccountListDto implements Serializable {
	...
	public AccountListDto(String nickname) {
		this.nickname = nickname;
	}

	public AccountListDto(long acctId, String acctName, String acctNickname,String email,String mobile,String telephone,
			long department,long position, Date createTime, String creator,
			boolean acctSuper) {
		super();
		this.id = acctId;
		this.name = acctName;
	...
	public String toString() {
		return "AccountListDto [id=" + id + ", name=" + name + ", nickname="
				+ nickname + ", email=" + email + ", mobile=" + mobile
				+ ", telephone=" + telephone + ", department=" + department
				+ ", position=" + position + ", date=" + date + ", creator="
				+ creator + ", time=" + time + ", initAccount=" + initAccount
				+ "]";
	}
