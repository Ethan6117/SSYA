...
function findListInfo() {
	$.post('mgr/planDetails/findPlanDetailsList', {
		page : page,
		weekOfYear : "201845"
	}, function(data) {
		dialog.close();
		...
		$.each(data.body, function(i, v) {
			...
			.append($('<td></td>').append(v.projectName))
			.append($('<td></td>').append(v.districts))
			.append($('<td></td>').append(v.task))
			.append($('<td></td>').append(v.description))
			.append($('<td></td>').append(v.planOrAdjust))
			.append($('<td></td>').append(v.staff))
			.append($('<td></td>').append(v.state))
			.append($('<td></td>').append(v.reason))
			.append($("<td class='1'></td>").append())
			.append($("<td class='2'></td>").append())
			.append($("<td class='3'></td>").append())
			.append($("<td class='4'></td>").append())
			.append($("<td class='5'></td>").append())
			.append($("<td class='6'></td>").append())
			.append($("<td class='7'></td>").append())			
			.append($('<td></td>').append(analyzeBtns(v)))
			.appendTo(tbody);
		});
	}, 'json');
	$.post('mgr/planDetails/findPlanDetailsCount', {
		page : page,
		weekOfYear : "201845"
	}, function(data) {
