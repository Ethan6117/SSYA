	...
	if(!$('#filePicker').length==0){
      ...
      //记录图片的信息
        ...
        uploader.on('ready', function() {
            ...
            var content_id = parseInt($("#contentId").val());
            var url = getURL();
            $.getJSON(url+"/member/initPic.jspx?id="+content_id,
        			function(json){
            		...
            		if(jsonLen!=0){ 
                        ...
                        $.each(json,function(i,n){
                          ...
                          obj.id=file_id ;
                          obj.name=n.newFileName;
                          obj.filename=n.newFileName;
        ...
        function editFile( file ) {  
            ...
            if ( file.getStatus() === 'invalid' ) {  
                ...
                $wrap.text( '不能预览' );               
                 ...
                 //读取文件流  
                 var thisurl = getURL();
                 var src= thisurl+file.path; 
                 img = $('<img src="'+src+'" style="height:100%;">');  
                 txt5=$("<p class=\"title1\"><textarea rows=\"2\" class=\"desc_text\" id=\"fileNameWU_FILE_"+ file.id +"\" name=\"fileNameWU_FILE_"+ file.id +"\" style=\"width:110px\">"+file.descriptive+"</textarea></p>");
